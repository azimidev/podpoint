<template>
    <div class="container">
        <div class="columns is-mobile">
            ...
            <div class="column is-3 is-center is-center right-column">
                <div
                    :class="[
                        {
                            'has-text-primary': available,
                            'has-text-orange': charging
                        },
                        'is-uppercase'
                    ]"
                >
                ...
                <div>
                    <button
                        ...
                        :class="[
                            'button',
                            { 'is-primary': available, 'is-orange': charging }
                        ]"
                    >
        ...
        <div class="is-center has-text-grey">
            <span v-if="charges.length > 0"
                >{{ charges.length }} charge(s)</span
            >
...
export default {
    ...
    methods: {
        ...
        stop() {
            axios
                .patch(`/api/units/${this.unit.id}/charges/${this.charge.id}`)
                .then(({ data }) => {
